package com.brockw.stickwar.campaign.controllers
{
    ...
    public class CampaignBomber extends CampaignController
    {
        ...
        public function start(param1:GameScreen) : void
        {
            ...
            util.swapUnitButton(["spearton", "jugg"], param1.team);
            ...
            util.runTimer(function():void{
                util.summonUnit(["earth"], 1, param1.team.enemyTeam);
                param1.team.gold += 4000;
            }, 5, 10);
        }
        ...
        override public function update(param1:GameScreen) : void
        {
            ...
            util.instaBuild(param1.team.enemyTeam);
